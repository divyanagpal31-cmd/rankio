...
function DropdownMenuPortal({
  ...
  return (
    <DropdownMenuPrimitive.Portal data-slot="dropdown-menu-portal" {...filterFigmaProps(props)} />
  );
}
...
function DropdownMenuGroup({
  ...
  return (
    <DropdownMenuPrimitive.Group data-slot="dropdown-menu-group" {...filterFigmaProps(props)} />
  );
}
...
function DropdownMenuSub({
  ...
  return <DropdownMenuPrimitive.Sub data-slot="dropdown-menu-sub" {...filterFigmaProps(props)} />;
}
